                            ...
                            <div class="post-header-without-more-button">
                                ...
                                <div class="post-header-textual-section">
                                    ...
                                    <div class="row-v-flex">
                                        <p class="regular-text"><a href="" class="post-date">$shared_post_date</a> <span style="font-size: 8px; color: white;">.</span></p>
...
EOS;
        ...
        public static function generate_comment($comment, $current_user_id) {
            ...
            */
            ...
            $comment_options = <<<CO
            <div class="relative comment" style="color: #ffffff;">
